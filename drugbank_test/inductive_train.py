...
parser.add_argument('--pkl_name', type=str, default='inductive_drugbank.pkl')
...
df_ddi_s2 = pd.read_csv('inductive_data/fold1/s2.csv')    ## S1 S2在这里读取

train_tup = [(h, t, r) for h, t, r in zip(df_ddi_train['d1'], df_ddi_train['d2'], df_ddi_train['type'])]
s1_tup = [(h, t, r) for h, t, r in zip(df_ddi_s1['d1'], df_ddi_s1['d2'], df_ddi_s1['type'])] ##新药对新药
s2_tup = [(h, t, r) for h, t, r in zip(df_ddi_s2['d1'], df_ddi_s2['d2'], df_ddi_s2['type'])] ##新药对已经存在的药
