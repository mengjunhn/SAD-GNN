...
parser.add_argument('--batch_size', type=int, default=512, help='batch size')  # 超参数批量的大小

parser.add_argument('--weight_decay', type=float, default=5e-4)
parser.add_argument('--neg_samples', type=int, default=1)
parser.add_argument('--data_size_ratio', type=int, default=1)
parser.add_argument('--use_cuda', type=bool, default=True, choices=[0, 1])
parser.add_argument('--pkl_name', type=str, default=root_path + '/drugbank_test/transductive_drugbank.pkl')
...
df_ddi_train = pd.read_csv(root_path + '/drugbank_test/drugbank/fold0/train.csv')
df_ddi_test = pd.read_csv(root_path + '/drugbank_test/drugbank/fold0/test.csv')
